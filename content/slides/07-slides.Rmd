...
as_tibble(sports) |>
  ...
  theme_xaringan(text_font_size = 34) +
...
companies |>
  ...
  geom_bar() +
  theme_xaringan(text_font_size = 22) +
  theme(axis.title.x = element_text(size = 40)) +
...
gapminder_continents |> 
  ggplot(aes(x = continent, # map continent to x
             y = n)) +      # map n countries to y
  geom_col()                # add bars #<<
```
...
"Reorder the factor variable continent by n"
]

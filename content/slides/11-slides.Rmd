...
Group project due this Friday, April 14 ([link](https://aem2850.toddgerarden.com/assignment/group-project/))
...
- Goal is to get practice without overloading you given the group project deadline this week
...
.center[
<figure>
  <img src="img/11/business-map-temps-anomalies.png" alt="July 1999 temperature anomalies" title="July 1999 temperature anomalies" width="50%">
  <img src="img/11/business-map-locations.png" alt="U.S. business locations" title="U.S. business locations" width="50%">
</figure>
]
...
.more-left.center[
<figure>
  <img src="img/11/white-house-framed-map.png" alt="White House framed map of election results" title="White House framed map of election results" width="95%">
</figure>
]

.less-right[
How is this **choropleth map** misleading?
]
...
Goal is to present information about *spatial geometries* according to some *attribute* (e.g., population, sales, etc.)
...
# Map the trip form Cornell to Cancun
...
Or make great circle plots: https://www.findingyourway.io/blog/2018/02/28/2018-02-28_great-circles-with-sf-and-leaflet/
...
.center[
<figure>
  <img src="img/11/shapefile-search.png" alt="Search for shapefiles" title="Search for shapefiles" width="50%">
</figure>
]

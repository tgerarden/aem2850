...
[Aesthetics in extra dimensions](#extra-dimensions)
...
background-image: url("img/05/napoleon-retreat.jpg")
...
.center[
<figure>
  <img src="img/05/napoleon-google-maps.png" alt="Moscow to Vilnius" width="90%">
...
knitr::include_graphics("img/05/minard.png")
```
...
<figure>
  <img src="img/05/gg-book.jpg" alt="ZZZ" title="ZZZ" width="55%">
</figure>
...
', eval = FALSE) %>% 
  ...
  knit_print.with_flair() # temporary bug fix
```
...
```{r show-basic-minard, echo=FALSE, fig.width=16, fig.height=8, out.width="85%"}
ggplot(data = troops,
       mapping = aes(x = longitude,
                     y = latitude,
                     color = direction,
...
knitr::include_graphics("img/05/gapminder-screenshot.png")
```
...
```{r head-gapminder-mask, echo=FALSE}
gapminder_2007 %>% 
  slice(1:2) %>% 
  mutate_all(as.character) %>% 
...
```{r gapminder-example-mask, echo=FALSE}
decorate('
ggplot(data = gapminder,
  ...
  scale_x_log10()
', eval = FALSE) %>%
  flair("gapminder", background = "#CBB5FF", before = "<b>", after = "</b>") %>% 
...
![](img/05/ggplot-layers-short@4x.png)
]
...
.center[
<figure>
  <img src="img/05/ggthemes.png" alt="ggthemes" title="ggthemes" width="55%">
</figure>
]
...
.center[
<figure>
  <img src="img/05/bbc-cookbook.png" alt="ggthemes" title="ggthemes" width="80%">
</figure>
]
...
.center[
<figure>
  <img src="img/05/excel-chart-types.png" alt="Excel chart types" title="Excel chart types" width="85%">
</figure>
]
]
...
```{r echo=FALSE, out.width='100%'}
knitr::include_graphics("img/05/tidydata_7.jpg")
```
...
.small[<http://graphics.wsj.com/hamilton/>]

.center[
<figure>
  <img src="img/05/hamilton.png" alt="Daveed Diggs in 'Washington On Your Side'" title="Daveed Diggs in 'Washington On Your Side'" width="65%">
</figure>
]
...
.center[
<figure>
  <img src="img/05/hamilton-1.png" alt="Daveed Diggs in 'Washington On Your Side'" title="Daveed Diggs in 'Washington On Your Side'" width="75%">
</figure>

<figure>
  <img src="img/05/hamilton-2.png" alt="Kendrick Lamar in 'good kid, m.A.A.d city'" title="Kendrick Lamar in 'good kid, m.A.A.d city'" width="75%">
</figure>
]

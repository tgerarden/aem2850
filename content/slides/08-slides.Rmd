...
[The dangers of dual y-axes](#dual-y-axes)
...
.small.center[
<figure>
  <img src="img/08/chart.png" alt="Spurious correlation between divorce rate and margarine consumption" title="Spurious correlation between divorce rate and margarine consumption" width="100%">
...
.center[
<figure>
  <img src="img/08/economist-dogs.png" alt="Dog neck size and weight in The Economist" title="Dog neck size and weight in The Economist" width="90%">
</figure>
]
...
.small.center[
<figure>
  <img src="img/08/triple-y-axis.png" alt="Acemoglu and Restrepo triple y-axis" title="Acemoglu and Restrepo triple y-axis" width="60%">
...
# How could we make this plot in R?

```{r}
ithaca_weather <- 
  read_csv("data/ithaca-weather-2021.csv")
...
.center[`Celsius = (Fahrenheit - 32) * 5/9`]
]
...
# Alternative 1: Use multiple plots

.center[
<figure>
  <figcaption>Solar panels in Japan</figcaption>
  <img src="img/08/solar-innovation-Japan.png" alt="Japanese solar market timeline" title="Japanese solar market timeline" width="75%">
</figure>
]
...
# Alternative 2: Use another aesthetic

.center[
<figure>
  <img src="img/05/gapminder-screenshot.png" alt="Animated gapminder data" title="Animated gapminder data" width="70%">
</figure>
]
...
.center[
<figure>
  <img src="img/08/slider-switch-plain-80.jpg" alt="Switch and slider" title="Switch and slider" width="100%">
</figure>
]
...
.center[
<figure>
  <img src="img/08/slider-switch-annotated-80.jpg" alt="Switch and slider" title="Switch and slider" width="100%">
</figure>
]

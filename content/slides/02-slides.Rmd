...
plot_countries <- where_were_from |> 
  mutate(
    region = case_when(
      ...
      country == "ROK (South Korea)" ~ "south korea",
      country == "I am a dual citizen of Korea and the US (+ I was raised in China)" ~ "south korea",
      country == "US & China" ~ "usa", # arbitrarily taking first response

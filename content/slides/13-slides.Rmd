...
Remaining deadlines:
  - Lab 13 will be due Monday
  - Lab 14 will be our example in class next Thursday
  - Prelim 2 on May 9 in class (two weeks from today)
...
Several people looked at the relationship between price and location:
...
Some people looked at other listing characteristics:

.pull-left[
<figure>
  <img src="img/13/prologue3.png" width="100%">
</figure>
]

.pull-right[
<figure>
  <img src="img/13/prologue4.png" width="100%">
</figure>
]
...
A few people branched out to other ideas and data:

.pull-left[
<figure>
  <img src="img/13/prologue5.png" width="100%">
</figure>
]
...
.pull-right[
<figure>
  <img src="img/13/prologue6.png" width="100%">
</figure>
]
...
Step 3: use `html_text2()` to convert the sports to a data frame
...
tidy_big_red <- full_join(
  ...
  pivot_longer(-sport, names_to = "pronoun", values_to = "has_team")
```

```{r}
tidy_big_red <- big_red_table |> 
  pivot_longer(c(1,2), names_to = "pronoun", values_to = "sport") |> 
...
What function could we use to determine how many pronoun-sport pairs there are in `tidy_big_red`?
...
What function could we use to determine how many distinct sports there are in `tidy_big_red`?
...
What function could we use to determine how many distinct sports are there for each pronoun?
...
<figure>
  <a href="https://en.wikipedia.org/wiki/College_and_university_rankings_in_the_United_States">
    <img src="img/13/college-rankings.png" width="90%">
  </a>
</figure>
]
...
Please contact Hui if you have questions about grading, see math errors, etc.

If you have follow-up questions after speaking with Hui, please contact me
...
- Overall presentation
  - Including the Logistics and Expectations for our perusal

--

Keep these in mind for the rest of the semester and for your future work!

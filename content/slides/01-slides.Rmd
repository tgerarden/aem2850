...
We can easily imagine generalizing this approach to other years, months, outcomes, etc.
...
Note: the NOAA data are published with a slight lag so this does not reflect snow since last week

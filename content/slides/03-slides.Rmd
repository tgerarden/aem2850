...
Submit assignments via gradescope
- Either via canvas or directly in gradescope
...
```{r, echo=FALSE}
# customize slightly to be more representative
responses |> 
  select(Concentration) |> 
...
We need to figure out what "path" to give `read_csv` to get to our file
...
# example-03-1:<br>import-data-practice.R
...
Reversing the arguments effectively transposes the original data:
...
# example-03-2:<br>tidy-data-practice.R

...
Plan for this week:
  - Tuesday: slides and example-14
  - Thursday: No class due to Thanksgiving Break
  
--

Plan for next week:
  - Tuesday: **Prelim 2 Q&A** and **Course evaluations**
  - Thursday: optional TA office hours in class
  - Thursday evening: **Prelim 2 at 7:30pm in MLT 228**
...
### Tuesday
  ...
  - [Time permitting: tf-idf](#tf-idf)
  - [Time permitting: n-gram ratios](#n-gram-ratios)
]

.pull-right[
### Thursday
  - *Thanksgiving Break:<br>No class on Nov 27*
]
...
**We will cover tokens and sentiment analysis** given time constraints
...
**n** contiguous tokens form an **n-gram**

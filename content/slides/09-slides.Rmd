...
**Prelim 1 regrade requests due this Thursday, October 23**

**Group projects will be due Friday, November 14** (not Nov 7!)
- **Instructions will be posted on canvas tomorrow**
- **We will post group member updates by tomorrow** (as needed)
- We will set up group-specific workspaces on posit cloud by Thursday
  - Note: we have encountered some issues with overwriting work in the past
  - Save your work early and often to avoid overwriting each other's work
  - We recommend backing up your individual code whenever you stop work
  - Use a collaborative editing platform like google docs for your code
...
### Tuesday
  ...
  - [Start example-09](#example-start)
]
...
### Thursday
  ...
  - [Finish example-09](#example-finish)

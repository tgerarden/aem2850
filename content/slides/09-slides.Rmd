...
Reminders:
- **Group project groups due this Friday (March 24)** ([canvas link](https://canvas.cornell.edu/courses/50706/assignments/501438))
  - Form groups of 3
...
[Visualizing time](#visualizing-time)
  ...
  - [Animating plots over time](#animations)
  - [Faceting plots over time](#faceting)
  - [Connecting scatter plots over time](#connected-scatter-plots)
...
- See [`vignette("lubridate")`](https://cran.r-project.org/web/packages/lubridate/vignettes/lubridate.html) and [Chapter 18 of R4DS (2e)](https://r4ds.hadley.nz/datetimes.html)
...
See [Chapter 18 of R4DS (2e)](https://r4ds.hadley.nz/datetimes.html) for functions to compute **periods** and **intervals**

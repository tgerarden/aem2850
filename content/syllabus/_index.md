...
You can also reach us by email. The best approach for generic, time-sensitive questions is to email all of us at the same time (and reply-all in follow-up emails). You can do that with one click [here](mailto:gerarden@cornell.edu,vs424@cornell.edu,jeg338@cornell.edu,ral346@cornell.edu,amt272@cornell.edu).

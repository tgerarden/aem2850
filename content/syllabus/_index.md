...
Generative AI (GenAI) tools such as ChatGPT, Claude, and GitHub Copilot are very powerful assistants for widely used programming languages like R.
...
<img src="images/horst_error_tweet.png" width="70%" /><img src="images/gator_error.jpg" width="70%" />
...
- **Class participation** and regular attendance are expected due to the interactive nature of this course.
  - Completing in-class **examples** are an important part of class participation and learning. **If you miss class, you are still expected to complete the in-class examples for any classes that you miss by the Saturday following the class you miss.**

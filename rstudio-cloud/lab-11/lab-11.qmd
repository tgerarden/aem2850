...
<!-- Hint: see slide 39 from Tuesday's lecture if you aren't sure where to start. -->
```{r}
...
{{< pagebreak >}}
## 8. Do something else interesting with these data, or with other spatial data. You could analyze other airbnb rating measures, or use other variables like price. You could compute the distance to wherever you spent spring break, or make a map of that location. Or just stop here. Your choice!

...
Much of the work in this class will be done via Quarto documents. Quarto documents are documents that combine text, R code, and R output, including figures. They are a great way to produce self-contained and documented statistical analyses.

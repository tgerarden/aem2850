...
ggplot(temps_houston, aes(x = ______, y = ______)) +
  ______()

# try again, using `geom_point()` instead of `geom_line()`
ggplot(temps_houston, aes(______ = day_of_year, ______ = temperature)) +
  ______()
...
ggplot(temperatures, aes(x = ______, y = ______, color = ______)) +
  ______()
...
ggplot(temperatures, aes(x = ______, y = ______, fill = ______)) +
  ______()

# can you color the lines of the boxplot by location and the interior by month?
ggplot(temperatures, ______) +
  geom_boxplot()

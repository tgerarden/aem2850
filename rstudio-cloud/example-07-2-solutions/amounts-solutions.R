...
# import data
beer_states <- read_csv("rstudio-cloud/example-06/beer_states.csv")
...
# import data
brewer_size <- read_csv("rstudio-cloud/example-06/brewer_size.csv")

# for 2019 only: map size to x, n_of_brewers to y, and add bars
brewer_size %>%
  filter(year == 2019) %>%

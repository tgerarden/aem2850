...
{{< pagebreak >}}
## 2. Visualize the price distribution across years, using the type of plot that you think is most appropriate. Show the median price per year in the plot. Add tweaks that you think can improve the plot. How do the distribution and the median price change over years?
